    ...
    <form onSubmit={onSubmit}>
      <Card>
        ...
        <textarea
          ...
          rows={4}
          maxLength={2000}
          placeholder="e.g., I'm building an AI-powered MDR for mid-market fintechs. Would you replace your current MDR with us if our detection MTTR is 40% faster but integration takes 6 weeks?"
