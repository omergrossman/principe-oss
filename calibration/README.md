...
| `gartner-2026-threats.json` | Gartner "How to Respond to the 2026-2027 Threat Landscape" ([redacted]) | 2026 | Synthesized from multiple Gartner CISO surveys + market data | **Licensed** — restricted to personal use of subscriber. Aggregate stats extracted for internal calibration use; not redistributed. License-compliance follow-up tracked. |
